    ...
    <div>
      <Modal active={active} setActive={undefined}>
        <div className={st.modalBlock}>
          <div className={st.modalTitle}>
            Are you really wants to delete Blog?
          </div>
          <div className={st.buttonBlock}>
            <Button
              onClick={() => {
                buttonYesHandler(blog.id);
              }}
            >
              Yes
            </Button>
      ...
      <div className={st.blogBlock}>
        <Modal active={updateModalActive} setActive={undefined}>
          <div className={st.modalBlockUpdate}>
            <div>
              <Button onClick={closeUpdateModalHandler}>X</Button>
            </div>
        ...
        <div>
          <img
            className={st.avatar}
            src={
              "https://thumbs.dreamstime.com/b/no-image-available-icon-simple-two-colors-template-no-image-picture-coming-soon-placeholder-no-image-available-icon-250657738.jpg"
            }
        ...
        <div className={st.textBlog}>
          ...
          <div>
            <span>Website:</span>
            <a className={st.link} href={blog.websiteUrl}>
              {blog.websiteUrl}{" "}
            </a>
          </div>
